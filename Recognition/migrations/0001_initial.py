    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_features', jsonfield.fields.JSONField(default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecturer_name', models.OneToOneField(limit_choices_to={'is_lecturer': True}, on_delete=django.db.models.deletion.CASCADE, related_name='lecturers', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ExamSession',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recognition.Departments')),
                ('lecturer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recognition.Lecturer')),
                ('unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recognition.Units')),
            ],
        ),
        migrations.CreateModel(
            name='Bookings',
            fields=[
                ...
                ('exam_session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recognition.ExamSession')),
